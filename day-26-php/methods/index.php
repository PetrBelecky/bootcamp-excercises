...
// get length of text
echo $chapter->getLength() . " characters" . '<br>'; 

// get number of words
echo $chapter->getNumberOfWords() . " words" .  '<br>';

// get number of sentences
echo $chapter->getNumberOfSentences() . " sentences" . '<br>';

// get number of paragraphs
echo $chapter->getNumberOfParagraphs() . " paragraphs" . '<br>';

// get most common words
echo 
  "The most used word with at least 4 chars is: <strong>" . 
  $chapter->getMostCommonWord() . 
  " </strong><br>";